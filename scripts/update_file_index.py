...
DESCRIPTIONS = {
    ...
    "Sources/Models/BatteryEstimate.swift": "LiPo % and time-left from batt volts (display-only)",
    "Sources/Models/GlucoseFrom940.swift": "940 nm → glucose hook (uncalibrated until model lands)",
    "Sources/Models/GlucoseRef.swift": "Libre / finger-poke reference glucose",
    "Sources/Store/ReadingStore.swift": "offline store, debounced saves, pending queue",
    "Sources/Store/MQTTAuth.swift": "MQTT wire credentials; partial Keychain becomes anonymous",
    ...
    "Sources/Networking/LocalNetworkGate.swift": "Bonjour browse to trigger iOS Local Network prompt",
    "Sources/Networking/NetworkPath.swift": "Wi-Fi vs cellular path for MQTT failover",
